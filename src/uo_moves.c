...
const uint64_t known_magics_P[64][2] = {
    ...
    [ 7 /* h1 */] = {1, 1},
    [ 8 /* a2 */] = {0x40, 3},
    [ 9 /* b2 */] = {0x402204200002, 4},
    [10 /* c2 */] = {0x8c8100800800122, 4},
    [11 /* d2 */] = {0x414828f800042, 4},
    [12 /* e2 */] = {0x8008080520200e2, 4},
    [13 /* f2 */] = {0x1009112048013000, 4},
    [14 /* g2 */] = {0x2000100100000280, 4},
    [15 /* h2 */] = {0x5002020500004000, 3},
    [16 /* a3 */] = {0xa006040000140a00, 2},
    [17 /* b3 */] = {0x41c0014200004094, 3},
    [18 /* c3 */] = {0x30, 3},
    [19 /* d3 */] = {0x48000048000800b0, 3},
    [20 /* e3 */] = {0x880009002012, 3},
    [21 /* f3 */] = {0x82000020000, 3},
    [22 /* g3 */] = {0x54000000000004, 3},
    [23 /* h3 */] = {0x24a1000008022044, 2},
    [24 /* a4 */] = {0x200040080485, 2},
    [25 /* b4 */] = {0x2004820482401000, 3},
    [26 /* c4 */] = {0x880040d24000000b, 3},
    [27 /* d4 */] = {0x801040008006812, 3},
    [28 /* e4 */] = {0x32102200000400c, 3},
    [29 /* f4 */] = {0x2421000000410200, 3},
    [30 /* g4 */] = {0x4024639208880090, 3},
    [31 /* h4 */] = {0x5081900288080008, 2},
    [32 /* a5 */] = {0xca08000000400004, 2},
    [33 /* b5 */] = {0x108085242402, 3},
    [34 /* c5 */] = {0x80000000011000, 3},
    [35 /* d5 */] = {0x1260508008020080, 3},
    [36 /* e5 */] = {0x2044104000c0010, 3},
    [37 /* f5 */] = {0x50000000118a000, 3},
    [38 /* g5 */] = {0x60740129081200, 3},
    [39 /* h5 */] = {0x8812541104001, 2},
    [40 /* a6 */] = {0x8080040125720000, 2},
    [41 /* b6 */] = {0x220028500000000, 3},
    [42 /* c6 */] = {0x21018082800108, 3},
    [43 /* d6 */] = {0x122009080200, 3},
    [44 /* e6 */] = {0x2001201, 3},
    [45 /* f6 */] = {0x844012000080800, 3},
    [46 /* g6 */] = {0x40000000a0460000, 3},
    [47 /* h6 */] = {0x10800410008000, 2},
    [48 /* a7 */] = {0x423101002004000, 2},
    [49 /* b7 */] = {0x2000c10180000200, 3},
    [50 /* c7 */] = {0x4048840000108, 3},
    [51 /* d7 */] = {0x300410040000c03, 3},
    [52 /* e7 */] = {0x2a0002422008001, 3},
    [53 /* f7 */] = {0x43104900250e1220, 3},
    [54 /* g7 */] = {0x2000000000228000, 3},
    [55 /* h7 */] = {0x88a986921008, 2},
    [56 /* a8 */] = {1, 1},
    [57 /* b8 */] = {1, 1},
    [58 /* c8 */] = {1, 1},
    [59 /* d8 */] = {1, 1},
...
bool uo_position_is_check(uo_position *pos, bool white)
{
  ...
  if (k & uo_moves_K[uo_ffs(k_enemy) - 1])
  {
    return true;
  }
...
uo_bitboard uo_position_moves(uo_position *pos, uo_square square, uo_position nodes[27 /* maximum number of legal moves for a single piece (queen) */])
{
  ...
  if (pos->p & mask)
  {
      ...
      uo_square move_square = 0;

      for (uint16_t i = 0, j = 0; i < move_count; ++i)
      {
        while (moves & ~uo_square_bitboard(move_square))
        {
          ++move_square;
        }

        uo_bitboard move = uo_square_bitboard(move_square);
